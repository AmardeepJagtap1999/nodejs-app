...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
        ...
        //res.json({'name': 'Amardeep Jagtap'});
        res.send({
		'name': 'The New Technologies',
		'technology': 'DevOps',
		'contact' : '7276456116',
		'email': 'amardeepjagtap199@gmail.com'
	            });
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('http://thenewtechnologies.com');
    });
    
 
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/thenewtechnologies");
      })
